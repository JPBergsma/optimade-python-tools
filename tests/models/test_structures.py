...
deformities = (
    ...
    (
        ...
        "chemical_formula_reduced 'Ge2Si2' is not properly reduced: GCD was 2, expected 1.",
    ),
    (
        {"chemical_formula_reduced": "Ge144Si60V24"},
        "chemical_formula_reduced 'Ge144Si60V24' is not properly reduced: GCD was 12, expected 1.",
    ),
    (
        {"chemical_formula_anonymous": "A10B5C5"},
        "chemical_formula_anonymous 'A10B5C5' is not properly reduced: GCD was 5, expected 1.",
    ),
    (
